...
const ContactDevModal: React.FC<ContactDevModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] flex items-center justify-center p-4 transition-all duration-700 ease-out ${isVisible ? 'opacity-100 backdrop-blur-3xl' : 'opacity-0 backdrop-blur-0'}`}
    >
      {/* Deep Overlay */}
          ...
          <div className="max-w-[480px]">
            ...
            <div className="space-y-6">
              ...
              <p className="text-[15px] text-white/60 leading-relaxed font-medium">
                Access is granted manually on a case by case basis. Before using this mode, please reach out to me directly and explain what you want to try and why.
              </p>
